...
svgField.setAttribute("width", FIELD_WIDTH);
svgField.setAttribute("height", FIELD_HEIGHT);
svgField.setAttribute("xmlns", "http://www.w3.org/2000/svg");
svgWrapper.appendChild(svgField);
...
field.setAttribute("fill", 'darkolivegreen');
field.setAttribute("xmlns", "http://www.w3.org/2000/svg");
svgField.appendChild(field);
