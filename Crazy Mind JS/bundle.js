...
var _MainBlock = __webpack_require__(5);

__webpack_require__(7);

var _RulesBlock = __webpack_require__(8);

var _RecordsBlock = __webpack_require__(10);
...
function switchToStateFromURLHash() {
    ...
    switch (SPAState.pagename) {
        case 'Main':
            app.innerHTML = _MainBlock.mainBlock;
            break;
        case 'Game':
...
exports.buildRecordBlock = undefined;
...
exports.buildGame = undefined;

var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();

var _ColorTest = __webpack_require__(13);

var _ColorTest2 = _interopRequireDefault(_ColorTest);

var _ShapeTest = __webpack_require__(14);
...
function buildGame() {
    ...
    var testTypes = Object.keys(tests);
    testTypes = testTypes.concat(testTypes, testTypes);
    var RoundsAmount = testTypes.length;
    var testDOM = void 0,
        mainOption = void 0,
        rightAnswersAmount = void 0;
    ...
    function buildNewTest() {
        var currentTest = testTypes.shift();
        gameBlock.innerHTML = '';
        switch (currentTest) {
            case "colorTest":
                var _ref = new _ColorTest2.default(checkColorTestAnswer);

                var _ref2 = _slicedToArray(_ref, 3);

                testDOM = _ref2[0];
                mainOption = _ref2[1];
                rightAnswersAmount = _ref2[2];
            ...
            case "shapeTest":
                var _ref3 = new _ShapeTest2.default(checkShapeTestAnswer);

                var _ref4 = _slicedToArray(_ref3, 3);

                testDOM = _ref4[0];
                mainOption = _ref4[1];
                rightAnswersAmount = _ref4[2];
...
var ColorTest = function () {
    function ColorTest(cbCheckAnswer) {
        _classCallCheck(this, ColorTest);
    ...
    _createClass(ColorTest, [{
        ...
        value: function touchEnd(e) {
            var deltaX = e.currentTarget.touchStartX - e.changedTouches[0].screenX;
            var deltaY = e.currentTarget.touchStartY - e.changedTouches[0].screenY;
            ...
            if (deltaX > 0 && Math.abs(deltaX) > Math.abs(deltaY)) {
                ...
                e.currentTarget.dispatchEvent(_event);
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            while (amountToAdd > 0) {
                colors.splice((0, _randomInt.randomInt)(0, colors.length), 0, colors[(0, _randomInt.randomInt)(0, colors.length - 1)]);
...
var ShapeTest = function () {
    function ShapeTest(cbCheckAnswer) {
        _classCallCheck(this, ShapeTest);
    ...
    _createClass(ShapeTest, [{
        ...
        key: 'drawSvg',
        value: function drawSvg(shape, i) {
            var svg = document.createElementNS("http://www.w3.org/2000/svg", 'svg');
            svg.setAttribute("width", 300);
            svg.setAttribute("height", 100);
            svg.setAttribute("xmlns", "http://www.w3.org/2000/svg");
            svg.setAttribute("xmlns:xlink", "http://www.w3.org/1999/xlink");
            var textShape = document.createElementNS("http://www.w3.org/2000/svg", 'path');

            switch (shape) {
                case 'line':
                    var randomLine = (0, _randomInt.randomInt)(25, 45);
        ...
        value: function render() {
            ...
            while (amountToAdd > 0) {
                shapes.splice((0, _randomInt.randomInt)(0, shapes.length), 0, shapes[(0, _randomInt.randomInt)(0, shapes.length - 1)]);
...
function readReady(callresult) {
    if (callresult.error != undefined) {
        ...
        exports.lastRecords = lastRecords = JSON.parse(callresult.result);
...
function lockGetReady(callresult) {
    if (callresult.error != undefined) console.log(callresult.error);else {
...
function updateReady(callresult) {
    callresult.error != undefined ? alert(callresult.error) : location.hash = 'Records';
}
...
var isRecord = function isRecord(V, I, A) {
